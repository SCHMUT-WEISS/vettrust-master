export const NAV_PAGES_LIST = (t: (key: string) => any) => [
  ...
  },
  {
    key: "Career",
    pathname: "/career",
    title: t("NAVIGATION.MENU_LIST.CAREER_TITTLE"),
    description: t("NAVIGATION.MENU_LIST.CAREER_DESCRIPTION"),
    disabled: false,
  },
  {
    key: "Academy",
    pathname: "/academy",
    title: t("NAVIGATION.MENU_LIST.ACADEMY_TITTLE"),
    description: t("NAVIGATION.MENU_LIST.ACADEMY_DESCRIPTION"),
    disabled: false,
    only: "de",
  },
  ...
  //   key: "SmartPaws",
  //   pathname: "/smart-paws",
  //   title: t("NAVIGATION.MENU_LIST.SMART_PAWS_TITTLE"),
  //   description: t("NAVIGATION.MENU_LIST.SMART_PAWS_DESCRIPTION"),
  //   disabled: false,
  // },
  {
    key: "AnimalKnowledge",
  ...
  //   key: "News",
  //   pathname: "/news",
  //   title: t("NAVIGATION.MENU_LIST.NEWS_TITTLE"),
  //   description: t("NAVIGATION.MENU_LIST.NEWS_DESCRIPTION"),
  //   disabled: false,
  // },
  {
    key: "GlobalPartners",
