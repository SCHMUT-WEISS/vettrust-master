...
const client = createClient({
  ...
  "fields.platformUrl": process.env.CLINICA_ALPINA_HOST,
});
...
async function run() {
  ...
  const newsArticlePageMeta = await client.getEntries({
    ...
    locale: "*",
    "fields.pageUrl[in]": process.env.CLINICA_ALPINA_HOST,
  });
  ...
  metaDataDE[jobsPagePath] = {
    title: `Clinica Alpina - ${deCareerTranslations.OUR_JOB_OFFERS.TITLE}`,
    description: `Clinica Alpina - ${deCareerTranslations.OUR_JOB_OFFERS.PARAGRAPH}`,
    image: DEFAULT_VETTRUST_META_IMAGE,
  ...
  metaDataEN[jobsPagePath] = {
    title: `Clinica Alpina - ${enCareerTranslations.OUR_JOB_OFFERS.TITLE}`,
    description: `Clinica Alpina - ${enCareerTranslations.OUR_JOB_OFFERS.PARAGRAPH}`,
    image: DEFAULT_VETTRUST_META_IMAGE,
    priority: generatePriority(jobsPagePath),
    lastmod: pageMeta?.items[0]?.sys?.updatedAt,
  };
  ...
  metaDataFR[jobsPagePath] = {
    title: `Clinica Alpina - ${frCareerTranslations.OUR_JOB_OFFERS.TITLE}`,
    description: `Clinica Alpina - ${frCareerTranslations.OUR_JOB_OFFERS.PARAGRAPH}`,
    image: DEFAULT_VETTRUST_META_IMAGE,
    priority: generatePriority(jobsPagePath),
    lastmod: pageMeta?.items[0]?.sys?.updatedAt,
  };
