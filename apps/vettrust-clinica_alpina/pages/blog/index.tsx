...
const BlogPage: NextPage<ComponentProps<NewsPageProps>> = ({
  pageMeta,
  deviceType,
}) => {
  ...
  const { heroBlogArticles } = pageMeta.fields;
  allArticles
  ...
  const blogArticlesNodes = useMemo(
    () =>
    ...
    <>
      ...
      >
        <div className="bg-white w-full h-[320px] lg:h-[416px] rounded-[12px] p-[20px] lg:p-[40px]">
          <HeroNewsCarousel
            news={heroBlogArticles.slice(0, 5)}
