...
const NewsLetterCardDesktop: React.FC<ComponentProps<NewsLetterCardProps>> = ({
  className,
  type,
  useVtTranslate,
  router
  ...
  return (
    <Formik
      ...
      validationSchema={newsletterSubscription(t, i18n as any)}
    >
      {({
        values,
        touched,
        ...
        return (
          <div
            className={` bg-white h-fit rounded-[12px] flex flex-col lg:flex-row gap-[16px] ${className}`}
          >
            <Section
              title={{
              ...
              backgroundColor=""
              className="py-[20px] lg:py-[40px] pl-[20px] lg:pl-[40px]"
            >
              <Paragraph type="body_1" className="w-full">
                {t("NEWS_PAGE.NEWS_LETTER.DESCRIPTION")}
              </Paragraph>
            </Section>
            <div className="pt-[80px] lg:pt-[40px] pb-[20px] lg:pb-[40px] pr-[20px] lg:pr-[40px] pl-[20px] lg:pl-[80px] w-[900px] rounded-[12px] news-letter__news-bg-image-desktop">
              <TextInput
...
export default NewsLetterCardDesktop;
